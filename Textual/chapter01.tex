...
A escassez de recursos hídricos constitui um dos desafios mais urgentes da atualidade. De acordo com a UN-Water (\cite{UNWater2024}), aproximadamente 4 bilhões de pessoas — quase dois terços da população global — enfrentam escassez hídrica severa durante ao menos um mês por ano, enquanto 2,2 bilhões de pessoas ainda não têm acesso a água potável segura (\cite{WHO2023}). Desse total, cerca de 1,7 bilhão de pessoas utilizam fontes de água contaminada por fezes, estimando-se aproximadamente 1 milhão de mortes anuais por doenças transmitidas por água contaminada (\cite{WHO2023}). Projeções indicam que a demanda global por água deverá superar a oferta em 40\% até 2030 (\cite{IDRA2026}), e que, até 2050, três em cada quatro pessoas poderão ser afetadas por impactos de seca. Nesse cenário, a Organização das Nações Unidas estabeleceu o Objetivo de Desenvolvimento Sustentável 6 (ODS 6), que trata da garantia de disponibilidade e gestão sustentável da água para todos, sendo a dessalinização explicitamente mencionada como tecnologia estratégica no Target 6.A (\cite{UNSDG6}).

Diante desse quadro, a dessalinização emerge não apenas como alternativa, mas como necessidade estratégica para ampliar a disponibilidade de água potável, especialmente em regiões costeiras e áreas remotas com acesso limitado a fontes convencionais de abastecimento. O mercado global de equipamentos de dessalinização tem crescido a uma taxa composta de 9,5\% ao ano, passando de US\$ 7,1 bilhões em 2021 para uma projeção de US\$ 11,2 bilhões em 2026 (\cite{IDRA2026}), refletindo a relevância crescente dessa tecnologia na diversificação das matrizes hídricas mundiais (\cite{Elimelech2011,Shannon2008,Shemer2023}).

No contexto brasileiro, a gestão de recursos hídricos enfrenta desafios significativos. Segundo a Agência Nacional de Águas (ANA), o ano de 2026 é considerado desafiador para a gestão da água no país, com chuvas abaixo da média histórica e o Sistema Cantareira operando com aproximadamente 30\% de sua capacidade (\cite{ANACNN2026}). A região Nordeste apresenta um regime particularmente severo, com apenas quatro meses de chuva contra oito meses de estiagem. Paralelamente, estudo da Confederação Nacional da Indústria (CNI) indica que a dessalinização tem potencial para reduzir o custo da água em até dez vezes, com valores entre R\$ 2,63 e R\$ 4,21 por metro cúbico, comparados a tarifas industriais que podem chegar a R\$ 43,29/m³ (\cite{CNI2026}). A maior planta de dessalinização em operação no país, localizada no Espírito Santo, já atende a uma demanda equivalente a 80 mil pessoas (\cite{CNI2026}).
...
O presente trabalho está inserido no contexto das atividades desenvolvidas no Laboratório de Micro e Nanofluídica e Microssistemas (LabMEMS) da Universidade Federal do Rio de Janeiro (UFRJ), no âmbito do projeto Ilha de Policogeração Sustentável (IPS), inaugurado em 2022 (\cite{COPPS2022}). O IPS consiste em um sistema pioneiro que integra painéis solares de alta concentração, capazes de gerar 5 kW de eletricidade (suficiente para aproximadamente 25 residências) e 8 kW de calor recuperável, a um dessalinizador do tipo V-AGMD com capacidade de produção de 1.000 litros de água destilada por dia, atendendo a mais de 100 pessoas. O sistema também conta com micro-trocadores de calor para reaproveitamento térmico, e tem como foco comunidades remotas e off-grid, como o semiárido nordestino, ilhas e áreas de desastre. O projeto está alinhado aos Objetivos de Desenvolvimento Sustentável (ODS) 6 (água potável e saneamento), 7 (energia limpa e acessível) e 13 (ação climática) (\cite{COPPS2022,UNSDG6}).
