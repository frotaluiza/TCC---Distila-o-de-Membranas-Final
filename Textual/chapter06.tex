...
% Linha de cima (alinhadas pelo topo)
\begin{subfigure}[t]{0.48\linewidth}
  \centering
  \includegraphics[height=5cm]{Imagens/chap06/overlay_ZohanResidual_Flux.png}
  \caption{Fluxo de permeado}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.48\linewidth}
  \centering
  \includegraphics[height=5cm]{Imagens/chap06/overlay_ZohanResidual_Ref_T_out.png}
...
\begin{subfigure}[t]{0.48\linewidth}
  \centering
  \includegraphics[height=5cm]{Imagens/chap06/overlay_ZohanResidual_Alim_T_out.png}
